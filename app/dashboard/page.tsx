...
export default function DashboardPage() {
    ...
    try {
      ...
      if (
        ...
        if (data.referrals && Array.isArray(data.referrals)) {
          const allPatientReferrals = data.referrals;
          console.log(
            "[v0] Total patient referrals found:",
            allPatientReferrals.length
          );
  ...
  const requestExtraCharges = async () => {
    ...
    try {
      const res = await fetch(
        `/api/billing/${selectedBillingForCharges._id}/extra-charges`,
        {
          method: "POST",
          headers: {
      ...
      if (res.ok) {
        toast.success(
          "Extra charges request sent to admin and receptionist for approval"
        );
  ...
  const handleAction = async (
    ...
    try {
      ...
      if (res.ok) {
        ...
        setRecentAppointmentReferrals((prev) =>
        ...
        const actionMessages = {
          accept:
            "✓ Referral accepted! You can now proceed with the treatment.",
  ...
  return (
    <ProtectedRoute>
          ...
          <div className="p-6 sm:p-4 md:p-6 lg:p-8">
            ...
            <div className="dashboard-header flex flex-col sm:flex-row gap-3 sm:gap-4 justify-between items-start sm:items-center mb-4 sm:mb-6 lg:mb-8 ">
              <div className="flex-1">
                <h1 className="dashboard-title text-xl sm:text-2xl lg:text-3xl">
                  ...
                  {user?.role === "doctor" && (
                    <>
                      ...
                      >
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Unregistered patients sent to reception for
                          appointment
                        </p>
                      </Link>
                    </>
                              ...
                              <td className="px-4 sm:px-6 py-3">
                                ...
                                >
                                  ...
                                  {referral.status.charAt(0).toUpperCase() +
                                    referral.status.slice(1).replace("-", " ")}
                                </span>
                              </td>
                              <td className="px-4 sm:px-6 py-3">
                                {(referral.status === "pending" ||
                                ...
                                {(referral.status === "completed" ||
                                  ...
                                  <button
                                    onClick={() =>
                                      setSelectedPatientReferral(referral)
                                    }
      ...
      <Dialog
        open={!!selectedPatientReferral}
        onOpenChange={(open) => !open && setSelectedPatientReferral(null)}
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              View patient referral information and status
            </DialogDescription>
          </DialogHeader>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-foreground font-medium">
                      {selectedPatientReferral.patientName}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground uppercase font-medium mb-1">
                  ...
                  <div>
                    ...
                    <p className="text-foreground font-medium">
                      {selectedPatientReferral.doctorName}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground uppercase font-medium mb-1">
                    ...
                    >
                      {selectedPatientReferral.status.charAt(0).toUpperCase() +
                        selectedPatientReferral.status
                          .slice(1)
                          .replace("-", " ")}
                    </span>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-foreground">
                      {new Date(
                        selectedPatientReferral.createdAt
                  ...
                  <div>
                    ...
                    <p className="text-foreground">
                      {new Date(
                        selectedPatientReferral.updatedAt
                      ).toLocaleDateString("en-US", {
                        year: "numeric",
                        month: "short",
                        day: "numeric",
      ...
      <Dialog
        open={showExtraChargesModal}
        onOpenChange={setShowExtraChargesModal}
      >
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Request Extra Charges</DialogTitle>
            <DialogDescription>
              Request additional charges for this billing record. Requires
              approval from admin or receptionist.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-4">
              <div className="bg-muted p-4 rounded-lg">
                ...
                <p className="text-xl font-bold text-foreground">
                  ${selectedBillingForCharges.totalAmount.toFixed(2)}
                </p>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 flex gap-2">
                ...
                <p className="text-sm text-blue-800">
                  This request will be sent to admin and receptionist for review
                  and approval.
                </p>
              </div>
