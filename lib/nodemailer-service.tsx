...
function generateAppointmentConfirmationEmail(
  ...
  const content = `
    ...
    <p style="color: #555;">Best regards,<br/>Dr.Mohammad Alsheikh Dental Center Team</p>
  `;
  return {
...
function generateAppointmentRescheduleEmail(
  ...
  const content = `
    ...
    <p>Best regards,<br/>Dr.Mohammad Alsheikh Dental Center Team</p>
  `;
  return {
...
export async function sendEmail(
  ...
  try {
    ...
    console.error(
      `  Failed to send ${eventType} email to ${to}: ${errorMessage}`
    );
